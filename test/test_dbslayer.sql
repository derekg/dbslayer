-- World test database for Slayer tests
--
-- This is a modification of the sample World database released by MySQL changed
-- to be UTF-8
--
-- MySQL dump 10.9
--
...
CREATE TABLE `TypeTest` (
	...
	`year` year NULL,
	`enum` enum('apple', 'orange', 'grapes') NULL,
	`set` enum('student', 'veteran', 'teacher') NULL,
	PRIMARY KEY (`id`)
